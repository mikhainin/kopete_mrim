...
public:
	...
	inline void setFlags(const ulong flags) {this->_flags = flags;};
	inline void setGroup(const ulong group) {this->_group = group;};
	inline void setAddress(const QString &address) {this->_address = address;};
